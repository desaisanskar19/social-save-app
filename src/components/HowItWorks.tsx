  ...
  return (
    <section id="how-it-works-section" className="max-w-6xl mx-auto px-4 sm:px-6 py-12 md:py-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
        {/* Step 1 */}
        <div className="bg-zinc-900 border border-zinc-800 rounded-[28px] p-6 sm:p-8 shadow-xl relative flex flex-col justify-between hover:border-zinc-700 transition-colors">
          <div>
            ...
            <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">
              Open Instagram or Facebook, locate the public post, reel, story, or video you wish to download, tap the <span className="font-semibold text-white">Share</span> button, and select <span className="font-semibold text-white">"Copy Link"</span>.
            </p>
          </div>
          <div className="mt-6 pt-4 border-t border-zinc-800 flex items-center gap-2 text-xs font-semibold text-[#fd1d1d]">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-[28px] p-6 sm:p-8 shadow-xl relative flex flex-col justify-between hover:border-zinc-700 transition-colors">
          ...
          <div className="mt-6 pt-4 border-t border-zinc-800 flex items-center gap-2 text-xs font-semibold text-[#1877F2]">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-[28px] p-6 sm:p-8 shadow-xl relative flex flex-col justify-between hover:border-zinc-700 transition-colors">
          <div>
            ...
            <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">
              Choose your desired format (1080p Full HD, standard MP4, audio MP3, or high-res cover JPG) and click <span className="font-semibold text-white">Download</span>.
            </p>
          </div>
          <div className="mt-6 pt-4 border-t border-zinc-800 flex items-center gap-2 text-xs font-semibold text-emerald-400">
        ...
        {activePlatformTab === 'instagram' ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-zinc-300">
            <div className="bg-zinc-950/80 p-5 rounded-2xl border border-zinc-800">
              ...
              <ol className="list-decimal list-inside space-y-2 text-xs leading-relaxed text-zinc-400">
                <li>Open the Instagram app and navigate to the Reel or Post.</li>
                <li>Tap the <strong className="text-white">Paper Airplane (Share)</strong> icon below the post or on the side of the Reel.</li>
                <li>Tap the <strong className="text-white">"Copy Link"</strong> button at the bottom tray.</li>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm text-zinc-300">
            <div className="bg-zinc-950/80 p-5 rounded-2xl border border-zinc-800">
              ...
              <ol className="list-decimal list-inside space-y-2 text-xs leading-relaxed text-zinc-400">
                ...
                <li>Tap the <strong className="text-white">Share</strong> button at the bottom of the post.</li>
                <li>Tap <strong className="text-white">More Options</strong> and select <strong className="text-white">"Copy Link"</strong>.</li>
            ...
            <div className="bg-zinc-950/80 p-5 rounded-2xl border border-zinc-800">
              ...
              <ol className="list-decimal list-inside space-y-2 text-xs leading-relaxed text-zinc-400">
                ...
                <li>Click the <strong className="text-white">three dots (...)</strong> on the top right of the post.</li>
                <li>Click <strong className="text-white">"Copy link"</strong>, or copy the direct URL from the address bar.</li>
