        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-slate-200 dark:border-zinc-800">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h2 className="text-xl sm:text-2xl font-bold text-zinc-900 dark:text-white uppercase tracking-wide">
                Download History
              </h2>
              <span className="text-xs font-semibold px-2.5 py-0.5 rounded-full bg-slate-100 dark:bg-zinc-950 text-zinc-700 dark:text-zinc-300 border border-slate-200 dark:border-zinc-800">
          ...
          {history.length > 0 && (
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 text-xs font-bold text-zinc-800 dark:text-white bg-slate-100 hover:bg-slate-200 dark:bg-zinc-800 dark:hover:bg-zinc-750 rounded-full border border-slate-300 dark:border-zinc-700 transition-colors cursor-pointer"
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-4 py-2 text-xs font-bold text-rose-600 dark:text-rose-400 hover:text-rose-700 dark:hover:text-rose-300 bg-rose-50 dark:bg-rose-950/40 hover:bg-rose-100 dark:hover:bg-rose-900/50 rounded-full border border-rose-200 dark:border-rose-900/60 transition-colors cursor-pointer"
              >
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 items-center justify-between">
                ...
                <button
                  ...
                  className={`px-4 py-1.5 rounded-full text-xs font-bold capitalize transition-colors cursor-pointer ${
                    filterPlatform === plt
                      ...
                      : 'bg-slate-100 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white'
                  }`}
                >
                  {plt}
                </button>
            ...
            <div className="relative w-full sm:w-64">
              ...
              <input
                ...
                className="w-full pl-10 pr-3 py-2 rounded-full text-xs bg-slate-100 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 text-zinc-900 dark:text-white placeholder-zinc-400 dark:placeholder-zinc-500 focus:outline-none focus:border-slate-400 dark:focus:border-zinc-700"
              />
            </div>
          </div>
        )}
        ...
        <div className="mt-6">
          {history.length === 0 ? (
            <div className="text-center py-12 px-4">
              <div className="w-16 h-16 rounded-2xl bg-slate-100 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 flex items-center justify-center mx-auto text-zinc-400 dark:text-zinc-500 mb-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {filtered.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className="border border-slate-200 dark:border-zinc-800 rounded-[20px] p-3.5 bg-slate-50/60 dark:bg-zinc-950 hover:border-slate-300 dark:hover:border-zinc-700 transition-all flex flex-col justify-between group shadow-sm"
                  >
                    <div>
                      {/* Thumbnail Container */}
                      ...
                      {/* Content Info */}
                      <h4 className="text-xs font-bold text-zinc-900 dark:text-white line-clamp-2 mb-1">
                        {item.title}
                      </h4>
                    ...
                    <div className="pt-2.5 border-t border-slate-200 dark:border-zinc-800/80 flex items-center justify-between">
                      <button
                        ...
                        className="text-xs font-semibold text-zinc-800 dark:text-white hover:text-[#fd1d1d] flex items-center gap-1 cursor-pointer transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="p-1 text-zinc-400 hover:text-rose-500 rounded-md transition-colors cursor-pointer"
